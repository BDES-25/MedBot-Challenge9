...
## Project Overview
This project was developed as part of the **ZAKA AI Certification (Challenge 9)**. It features a specialized Medical AI assistant (MedBot) fine-tuned on medical datasets using **LoRA (Low-Rank Adaptation)** and deployed as a containerized web application.
